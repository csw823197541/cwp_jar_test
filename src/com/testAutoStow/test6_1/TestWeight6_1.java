 ...
 */
public class TestWeight6_1 {

    public static SimpleDateFormat sdf = new SimpleDateFormat("yyyy-MM-dd HH:mm:ss");

    public static void main(String[] args) throws Exception {

        String filePath = "data/autoStowData/6.1/STOW-WEIGHT贝塔出口航次：FJBHDME进口航次：FJBHDMI-20190909142732525/";

        String stowImportDataJson = FileUtil.readFileToString(new File(filePath + "smartStowWeightImportDataJson.txt")).toString();
        ...
        autoStowManager.callWeightLevelMaker(smartStowImportData, smartStowResults);
