...
public class Test5_3 {
    ...
    public static void main(String[] args) throws ParseException {
        ...
        String filePath = "data/cwpData/5.2/5.3/CWP霍斯沙克尔顿出口航次：815N进口航次：815NI-20180417110056620/";
...
//        smartCwpImportData.setSmartCranePoolInfoList(smartCranePoolInfoList);
        ...
        SmartCwp3Results smartCwp3Results = smartCwpGenerator.doPlanCwp3(smartCwpImportData, null);
        System.out.println(smartCwp3Results.getSmartReCwpModalInfoList().size());
